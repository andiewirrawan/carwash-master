        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-xl font-bold tracking-tight text-[#0A2A5E] sm:text-2xl flex items-center gap-2">
              ...
              Backup & PITR Storage Settings
            </h1>
            <p className="text-xs text-slate-500 mt-1">
              Panduan Point-in-Time Recovery (PITR) Supabase & Export otomatis 2 lapis (JSON/CSV dump).
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-amber-200 bg-white p-5 shadow-xs space-y-3">
            <div className="flex items-center gap-2 text-[#0A2A5E] font-bold text-sm">
              ...
              Lapis 2: Export Mingguan ke Google Drive / Storage Terpisah
            </div>
            <p className="text-xs text-slate-600 leading-relaxed">
              Jadwalkan export otomatis mingguan yang nge-dump tabel-tabel utama (<code className="font-bold text-amber-800">transactions</code>, <code className="font-bold text-amber-800">customers</code>, <code className="font-bold text-amber-800">transaction_staff</code>, <code className="font-bold text-amber-800">komisi_manual</code>, <code className="font-bold text-amber-800">price_list</code>, <code className="font-bold text-amber-800">staff</code>) ke file CSV/JSON tersimpan secara independen dari Supabase.
            </p>
            ...
            <div className="pt-2 flex flex-wrap gap-2">
              <button
                ...
                disabled={exporting}
                className="inline-flex items-center gap-2 rounded-lg bg-[#0A2A5E] px-3.5 py-2 text-xs font-bold text-white shadow-xs hover:bg-blue-900 transition-colors"
              >
              ...
              <button
                ...
                disabled={exporting}
                className="inline-flex items-center gap-2 rounded-lg bg-emerald-700 px-3.5 py-2 text-xs font-bold text-white shadow-xs hover:bg-emerald-800 transition-colors"
              >
            ...
            >
              {copied ? (
                <>
                  ...
                  <span className="text-emerald-700">Berhasil Dikuasai / Copied!</span>
                </>
              ) : (
                <>
